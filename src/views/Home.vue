<template>
    <div class="home">
        <router-link to="pageA">TO pageA</router-link>
        <br/>
        <router-link to="pageB">TO pageB</router-link>
        <br/>
        <keep-alive>
        ...
        <keep-alive>
            <component v-bind:is="changes"></component>
        </keep-alive>

        <div @click="changeComponent('a')">changeA</div>
        <div @click="changeComponent('b')">changeB</div>
